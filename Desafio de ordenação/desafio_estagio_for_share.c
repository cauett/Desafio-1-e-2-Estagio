...
void organizarLetras(char *vetLetras, int *vetNums, int lines) 
{
    ...
    leituraArq = fopen(/* local do arquivo */, "r"); //arq. de entrada
    ...
    ordenarLetras = fopen(/* local do arquivo */, "w"); //arq. letras
...
void organizarNumeros(int *vetNums, char *vetLetras, int lines)
{
    ...
    ordenarNums = fopen(/* local do arquivo */, "w"); //arq. números
...
{   
    ...
    char *vetLetras[lines][100];
    int *vetNums[lines];
    
    organizarNumeros(&vetNums[0], &vetLetras[0], lines);
    printf("Arquivo organizado!\n");
    
    organizarLetras(&vetNums[0], &vetLetras[0], lines);
    printf("Arquivo organizado!\n");
